...
public class Assignment2Part3 extends WindowProgram {
    ...
    private void drawPawprint(double x, double y) {
        ...
        GOval firstFinger = new GOval(x + FIRST_TOE_OFFSET_X, y + FIRST_TOE_OFFSET_Y, TOE_WIDTH, TOE_HEIGHT);
        firstFinger.setFilled(true);
        firstFinger.setColor(Color.BLACK);
        add(firstFinger);
        GOval secondFinger = new GOval(x + SECOND_TOE_OFFSET_X, y + SECOND_TOE_OFFSET_Y, TOE_WIDTH, TOE_HEIGHT);
        secondFinger.setFilled(true);
        secondFinger.setColor(Color.BLACK);
        add(secondFinger);
        GOval thirdFinger = new GOval(x + THIRD_TOE_OFFSET_X, y + THIRD_TOE_OFFSET_Y, TOE_WIDTH, TOE_HEIGHT);
        thirdFinger.setFilled(true);
        thirdFinger.setColor(Color.BLACK);
        add(thirdFinger);
        GOval hell = new GOval(x + HEEL_OFFSET_X, y + HEEL_OFFSET_Y, HEEL_WIDTH, HEEL_HEIGHT);
        hell.setFilled(true);
